...
export const ContactUs = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const serviceId = "service_n82e09s";
    const templateId = "template_cyfgl5v";    
    const apikey = "xZEHhhQ4vOYV0y3IU"
  ...
  return (
    <form ref={refForm} action="" onSubmit={handleSubmit}>
      ...
      <fieldset className='field-name'>
        ...
        <input name='username' type="text" placeholder='Ej: BrallanG' required />
      </fieldset>
      <fieldset className='field-email'>
        <label className='symbol-required' name='email'>Email</label>
        <input placeholder='Ej: brallang@gmail.com' type="email" name="emailuser" id="email" required />
      </fieldset>
